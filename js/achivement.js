document.addEventListener("DOMContentLoaded", function () {
    ...
    function fetchAchievements() {
        axios.get('https://ieeeausb.onrender.com/api/achievements')
            .then(response => {
    ...
    window.editAchievement = function (id) {
        axios.post(`https://ieeeausb.onrender.com/api/achievements/update/${id}`)
            .then(response => {
    ...
    window.deleteAchievement = function (id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                axios.delete(`https://ieeeausb.onrender.com/api/achievement/${id}`)
                    .then(response => {
                        fetchAchievements();
    ...
    form.addEventListener('submit', function (event) {
        ...
        if (achievementId) {
            axios.post(`https://ieeeausb.onrender.com/api/achievements/update/${achievementId}`, formData)
                .then(handleResponse)
                .catch(handleError);
        } else {
            axios.post('https://ieeeausb.onrender.com/api/achievements/upload', formData)
                .then(handleResponse)
                .catch(handleError);
        }
    });
