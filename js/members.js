document.addEventListener("DOMContentLoaded", function () {
  ...
  function fetchData() {
    axios.get('https://ieeeausb.onrender.com/api/members')
      .then(response => {
  ...
  window.editMember = function(id) {
    axios.post(`https://ieeeausb.onrender.com/api/members/update/${id}`)
      .then(response => {
  ...
  window.deleteMember = function (id) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        axios.delete(`https://ieeeausb.onrender.com/api/member/${id}`)
          .then(response => {
            fetchData();
            Swal.fire(
              'Deleted!',
  ...
  form.addEventListener('submit', function (event) {
    ...
    const url = memberId ? `https://ieeeausb.onrender.com/api/members/update/${memberId}` : 'https://ieeeausb.onrender.com/api/members/upload';
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  async function fetchMembers() {
    try {
      const response = await axios.get('https://ieeeausb.onrender.com/api/members'); // Adjust the URL to your actual API endpoint
